...
/*
  //
  // Marlin 2.0 Status Screen Options
  //
  ...
  var $img        = $('<img/>'),
      ...
      generate_cpp = function(e,no_render) {
        ...
        var bytewidth = tobytes(iw),                          // Bytes wide is important
            ...
            type = $type.val(),                               // The selected output type
            name = type == 'boot' ? 'custom_start_bmp' :
                   type == 'stat1' ? 'status_screen0_bmp' :
                   type == 'stat2' ? 'status_logo_bmp' :
                   'bitmap_' + rnd_name,
            ...
            is_stat1 = type == 'stat1',                        // "Status 1.1" has extra options
            is_stat2 = type == 'stat2',                       // "Status 2.0" has extra options
            is_lpad = is_stat1 && !$rj[0].checked,            // Right justify?

            rjust_add = tobytes(max_size[0]) - bytewidth,
            extra_x = /* is_stat1 ? rjust_add : */ 0;     // TODO: Status screen composer.
        ...
        */
        ...
        $('#where').html(
          ...
          type == 'stat1' || type == 'stat2' ? '<strong><tt>_Statusscreen.h</tt></strong>' :
          'program'
        );
